...
public:
    ...
    /** Block until a pending fullscreen/size transition has been applied;
     *  SDL3 applies them asynchronously where SDL2 did so before returning. */
    virtual void SyncWindow() {}
